...
const CopyWebpackPlugin = require('copy-webpack-plugin'); //Archivo necesario para trabajar con HTML.

/** @type {import('webpack').Configuration} */
module.exports = { 
    mode: 'development', //Aquí se encuentra toda la configuración de lo que va a suceder. Modulo para exportar.
    ...
    output: { //Donde se envía el proyecto estructurado y compilado listo para producción.
        ...
        filename: '[name].js' //Este es el nombre del archivo final para producción.
    },
      devServer: {
        hot: true,
        open: true,
